...
echo y | pscp -p -pw %password% %path_from%\%file_prefix%* %host_username%@%host_name%:%remote_source_dir%/%env_sid%/%path_to%
...
if %try_counter% gtr 3 (
	...
	echo Please contact Development Services, as this script has failed on %host_name%.
